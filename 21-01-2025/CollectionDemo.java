...
public class CollectionDemo{
	public static void main(String[] args){
		...
		System.out.println("old size = "+v1.size());
		v1.add("Hello");
		v1.add(20);
		v1.add(new Date());
		v1.add(new Thread());
		...
		System.out.println("new size = "+v1.size());
	...
	System.out.println("\n________________________________________________________________________________________________");
		...
		set1.add(2);
		//set1.add("Hello");
		/* Gives error as TreeSet sorts the elements and it need to compare two elements for that, it gives error as we cannot compare Integer with String */
